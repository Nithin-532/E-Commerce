...
const ChevronIcon = <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-up" viewBox="0 0 16 16">
  ...
  return (
    <>
          ...
          <div className='container-fluid d-flex align-items-center justify-content-between'>
            ...
            <div className='filter-icon d-block d-md-none'>
              <a className="btn" data-bs-toggle="offcanvas" href="#offcanvasExample" role="button" aria-controls="offcanvasExample">
                <p style={{ margin: 0, marginRight: '10px', cursor: 'pointer' }} >{FilterIcon}</p>
              </a>
            </div>
            <div className='offcanvas offcanvas-start' tabIndex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel" style={{ width: '250px' }}>
              ...
              <div className='offcanvas-body' style={{ padding: 0, overflow: 'hidden' }}>
                <FilterComponent />
              </div>
            </div>
          </div>
      ...
      <div className='d-flex flex p-2'>
        ...
        <div className='container text-center' style={{ padding: 0, maxWidth: "100%" }}>
    ...
    <div className='d-flex border flex-column sidebar'>
      <div className='w-100 p-2 border-bottom'>
        <div className='d-flex flex-column w-100'>
          <a className="btn" data-bs-toggle="collapse" href="#collapseExample1" role="button" aria-expanded="false" aria-controls="collapseExample1" onClick={() => setIsCollapsed1(prev => !prev)}>
            <div className='d-flex justify-content-between align-items-center w-100'>
              <h5 style={{ margin: 0 }}>Categories</h5>
              <p style={{ margin: 0 }} className={`icon ${isCollapsed1 === true && "rotate"}`}>{ChevronIcon}</p>
            </div>
          </a>
      ...
      <div className='w-100 p-2 border-bottom'>
        <div className='d-flex flex-column w-100'>
          <a className="btn" data-bs-toggle="collapse" href="#collapseExample2" role="button" aria-expanded="false" aria-controls="collapseExample2" onClick={() => setIsCollapsed2(prev => !prev)}>
            <div className='d-flex justify-content-between align-items-center w-100'>
              <h5 style={{ margin: 0 }}>Brands</h5>
              <p style={{ margin: 0 }} className={`icon ${isCollapsed2 === true && "rotate"}`}>{ChevronIcon}</p>
            </div>
          </a>
      ...
      <div className='w-100 p-2 border-bottom'>
        <div className='d-flex flex-column w-100'>
          <a className="btn" data-bs-toggle="collapse" href="#collapseExample3" role="button" aria-expanded="false" aria-controls="collapseExample3" onClick={() => setIsCollapsed3(prev => !prev)}>
            <div className='d-flex justify-content-between align-items-center w-100'>
              <h5 style={{ margin: 0 }}>Price</h5>
              <p style={{ margin: 0 }} className={`icon ${isCollapsed3 === true && "rotate"}`}>{ChevronIcon}</p>
            </div>
          </a>
